...
1. **Create a new bookmark** in your browser bookmarks bar.

2. **Name it** something clear like `Quick links tool`.

3. **Paste the bookmarklet code** into the bookmark URL field instead of a normal web address. You only need to do this once; updates are automatic.

4. **Launch the tool**: Open any Halfords page and click the bookmark to launch the widget.
